...
" The amount of colors used is based on an underestimation.
" If no solution is found the algorithm is ran again with 1 more colour.
...
" Will find a solution with the least amount of colours, reasonably fast.
"
